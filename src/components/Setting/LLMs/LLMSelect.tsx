...
const LLMs = [
  ...
  },
  {
    id: 1,
    name: "Gemini",
    logo: <SiGooglegemini size={40} />,
    bg: "bg-geminisecondary",
  ...
  },
  {
    ...
    logo: (
      <svg
        role="img"
        className="size-10 fill-primary"
        viewBox="0 0 24 24"
...
const LLMSelect = () => {
  ...
  return (
    <div>
      <p className="text-md font-bold">LLMの設定</p>
